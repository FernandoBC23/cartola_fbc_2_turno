...
(function () {
  ...
  window.addEventListener("DOMContentLoaded", () => {
    ...
    function renderPainelCompleto(numeroRodada) {
      ...
      Object.entries(classificacaoSerieB || {}).forEach(([grupo, times]) => {
...
//         <code>window.participantesSerieA</code> (ou <code>participantesLiga_serie_B</code>/<code>participantesLiga</code>)
//         antes deste script.
//       </div>`;
//     return;
//   }
