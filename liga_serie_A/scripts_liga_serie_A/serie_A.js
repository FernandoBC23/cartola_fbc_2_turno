...
//     const escudosTimes = {
//       "SISO FC25": "../imagens/2_siso_fc25.png",
//       "Atlético Colorado 2021": "../imagens/2_atletico_colorado_2021.png",
...
//     // "ITAQUI F.C.": "../imagens/2_itaqui_fc.png",
...
// scripts_liga_serie_A/serie_A.js
// Lista simples dos times da Série A (Pos | Time)

document.addEventListener("DOMContentLoaded", () => {
  const container = document.getElementById("lista-serie-a");
  if (!container) return;

  // 1) fonte da lista
  const times =
    (Array.isArray(window.participantesSerieA) && window.participantesSerieA) ||
    (Array.isArray(window.participantesLiga_serie_A) && window.participantesLiga_serie_A) ||
